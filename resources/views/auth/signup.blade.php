...
<h2 class="text-center text-dark font-weight-bold my-4">Sign Up</h2>
<form action="">
    ...
    <input type="submit" value="Sign Up" class="btn btn-primary btn-block mb-5">
</form>

@stop
@section('auth-content-under')
<p class="text-white text-center small">Already Have Account? <a href="#" class="font-weight-bold text-white">LOGIN</a></p>
@stop